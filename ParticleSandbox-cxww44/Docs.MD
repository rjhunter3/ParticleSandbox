...
- index.html and index.js containing HTML and javascript to set up the example page and provide controls to interact with ParticleSandbox.js
and play around with some of the properties of the class.
